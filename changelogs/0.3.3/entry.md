...
<!-- Pliny and Diophantus, named here as "still ahead" in earlier drafts, both
     landed above. Remaining era-2 texts below. -->

A few texts remain for the era's shelf: Seneca's *Natural Questions*, Iamblichus's *Life of Pythagoras*, and Frontinus on the aqueducts of Rome. After that, the era's texts turn from acquisition to composition — sequencing Rome as the Grand Tour's second section, and the supplements that go with it.
