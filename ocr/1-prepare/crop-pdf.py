...
Usage:
    python3 ocr/1-prepare/crop-pdf.py source/Elements.pdf source/Elements-trimmed.pdf \\
        --margins 70 50 70 50

    python3 ocr/1-prepare/crop-pdf.py source/Elements-trimmed.pdf source/left.pdf \\
        --bbox 0 0 256 792
