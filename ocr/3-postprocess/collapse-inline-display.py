...
Usage:
    python3 ocr/3-postprocess/collapse-inline-display.py [path ...]
    python3 ocr/3-postprocess/collapse-inline-display.py --dry-run [path ...]
    python3 ocr/3-postprocess/collapse-inline-display.py --max-len 80 [path ...]
