...
r"""Decode HTML entities that survived conversion into the markdown.
  ...
  ocr/3-postprocess/decode-html-entities.py                 # dry run over the whole corpus
  ocr/3-postprocess/decode-html-entities.py --apply
  ocr/3-postprocess/decode-html-entities.py --apply texts/1-ancient-greece/foo/foo.md
