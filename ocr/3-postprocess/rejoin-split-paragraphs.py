...
Usage:
    python3 ocr/3-postprocess/rejoin-split-paragraphs.py <markdown> --blank
    python3 ocr/3-postprocess/rejoin-split-paragraphs.py <markdown> --rule --apply
    python3 ocr/3-postprocess/rejoin-split-paragraphs.py <markdown> --rule --blank
"""
