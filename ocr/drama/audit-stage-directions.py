...
Usage:
    python3 ocr/drama/audit-stage-directions.py <markdown>
    python3 ocr/drama/audit-stage-directions.py <markdown> --summary
    python3 ocr/drama/audit-stage-directions.py <markdown> --category unclosed-multi-line
