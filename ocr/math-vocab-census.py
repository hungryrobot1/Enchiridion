...
Usage:
    python3 ocr/math-vocab-census.py                 # every markdown text
    python3 ocr/math-vocab-census.py <path ...>      # specific texts
    python3 ocr/math-vocab-census.py --text ptolemy-almagest
    python3 ocr/math-vocab-census.py --json out.json # machine-readable
    python3 ocr/math-vocab-census.py --min-distinct 6
"""
