...
Modes:
    python3 ocr/reflow-derivations.py FILE [FILE ...]           # dry-run report
    python3 ocr/reflow-derivations.py --apply FILE [FILE ...]   # rewrite in place
    python3 ocr/reflow-derivations.py --p3 FILE [FILE ...]      # list P3 lines
