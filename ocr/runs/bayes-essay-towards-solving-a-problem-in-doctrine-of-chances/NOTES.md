...
The slow work was visual adjudication of compact eighteenth-century formulas,
especially pp. 395–403 and 415–418. That difficulty is intrinsic: OCR produced
parseable alternatives, so rendering checks could not distinguish them. A
smaller but avoidable share went to locating acceptance limits and reconstructing
which generic checks covered which defect class.
