...
**The text:** Thomas Bayes, *An Essay towards Solving a Problem in the Doctrine of Chances* (`bayes-essay-towards-solving-a-problem-in-doctrine-of-chances`). Its sources are in `source/`,
