...
The most intricate work was editorial scope and voice separation, not file
conversion. A single physical volume contains several complete works and
critical variants; pagination and direct page reading were stronger evidence
than file adjacency or label frequency. The apparatus synonyms and the one
OCR-demoted bracket label required three escalation/review cycles. That time
was necessary because a broad removal heuristic could silently delete fluent
Copernican prose.

Figure review was the next substantial cost: 140 mappings across 14 contact
sheets. That was genuinely visual work. Numerical tables remain the largest
unpaid correctness cost because current checks can establish row shape but not
digit fidelity.

The standard PDF recon's placement inventory was comparatively slow on this
454-page file and did not add useful routing evidence beyond the existing
corpus audit and targeted samples; that was tooling friction. Preparation,
duplicate scanning, asserted postprocessing, and the final controlled checks
ran in seconds once the judgments were settled.
