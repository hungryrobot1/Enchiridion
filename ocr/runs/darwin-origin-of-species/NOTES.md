...
Most time went into inspecting XHTML structure and building assertions that
distinguish the work from Gutenberg/package furniture. That work was genuinely
necessary because a wrong apparatus boundary can delete Darwin silently. A
second substantial block went into proving the diagram was absent from both
container markup and rendered PDF pages, then pinning and visually checking the
acquired plate. Renderer checks and identity checks were quick.
