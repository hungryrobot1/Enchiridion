...
Preparation was slow because the crop decision required whole-range geometry,
not because selecting 462 pages is intrinsically difficult. Postprocessing was
slow because the edition's notes serialize in several shapes: ordinary tails,
multi-page continuations, a prefix before Euler resumes, and one complete note
inside a display block. Stage 4 was genuinely intricate: a small rare-command
sample led to several different printed causes—real notation, editorial
callouts, handwritten marginalia, and semantic OCR errors—and each required a
page read. No attempt was made to disguise the much larger remaining human
proofreading cost.
