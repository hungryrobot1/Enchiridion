...
Most time went into inspecting source structure after apparently successful
recon and extraction. Formula recovery itself was cheap; distinguishing the 52
actual displays from the 37 height-classified ones and auditing the late
calculus cluster took the substantive work. The other slow part was separating
internally forced symbolic repairs from readings that only a printed witness can
settle. That is genuinely intricate editorial work. Re-running and localizing
the same facts across several overlapping documents was tooling/documentation
overhead.
