...
Extraction itself was immediate. Most time went to reading the raw XHTML,
adjudicating the preface/translator boundary against the rendered PDF, and
classifying all 65 images by archive membership, spine use, dimensions,
duplication, and visual content. That work was genuinely necessary because the
figures carry the geometrical argument and because the brief's count and
category labels did not match the archive's actual structure. The numerical
variant census was cheap and found the one bounded open reading on page 84.
