...
**The text:** Ada Lovelace, Luigi Menabrea, *Sketch of the Analytical Engine, with Notes by the Translator* (`lovelace-sketch-of-the-analytical-engine`). Its sources are in `source/`,
