...
Exact scope and voice ownership required rendered-page reading but were intrinsically important. Table inspection and page-turn repair took most of stage 3 because the scan uses vertical table continuations, catchwords, signatures, and marginal labels that a blanket paragraph join confuses with prose. The general tools made the renderer checks and duplicate scan quick. The standard recon tool was disproportionately expensive: on three attempts it printed the cheap document header and then died during image inventory before reaching its text-quality and route verdict.
