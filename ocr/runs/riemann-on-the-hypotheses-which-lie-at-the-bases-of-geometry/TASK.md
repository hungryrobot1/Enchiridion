...
**The text:** Bernhard Riemann, *On the Hypotheses Which Lie at the Bases of Geometry* (`riemann-on-the-hypotheses-which-lie-at-the-bases-of-geometry`). Its sources are in `source/`,
