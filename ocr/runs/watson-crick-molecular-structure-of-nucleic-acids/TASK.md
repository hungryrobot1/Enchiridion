...
**The text:** James Watson, Francis Crick, *Molecular Structure of Nucleic Acids: A Structure for Deoxyribose Nucleic Acid* (`watson-crick-molecular-structure-of-nucleic-acids`). Its sources are in `source/`,
